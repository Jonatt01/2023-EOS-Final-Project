...
//*********************************start of reservation command*********************************//
    memset(message,0,MAX_BUFFER_SIZE);
    memset(buffer,0,MAX_BUFFER_SIZE);
    msglen = sprintf(message,"reservation 5 | user Jonathan | bedroom light 3 | livingroom fan 2");
    write(sockfd,message,msglen+1);
...
//*********************************start of reservation command*********************************//
    memset(message,0,MAX_BUFFER_SIZE);
    memset(buffer,0,MAX_BUFFER_SIZE);
    msglen = sprintf(message,"reservation 10 | user Jonathan | bedroom light 0 | livingroom fan 0");
    write(sockfd,message,msglen+1);
    printf("Sent reservation to server: %s\n", message);
